...
export function ResultItem({ fileData }) {
    ...
    return (
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-white rounded-lg border-2 border-[var(--c-border)] transition-all hover:bg-gray-50">
